...
#define NUMBER_KEYS LAYOUT_ergodox_pretty(\
       ...
       _______   ,     _______   ,     _______   ,     _______   ,    _______    ,    _______    ,    _______    ,                                                                                    _______    ,     PLUS      ,        KC_7   ,      KC_8     ,     KC_9      ,    MULITPLY   ,    _______    ,\
       _______   ,     _______   ,     _______   ,     _______   ,    _______    ,    _______    ,                                                                                                                     MINUS     ,        KC_4   ,      KC_5     ,     KC_6      ,    DIVIDE     ,    _______    ,\
       _______   ,     _______   ,     _______   ,     _______   ,    _______    ,    _______    ,    _______    ,                                                                                    EQUAL      ,     KC_0      ,        KC_1   ,      KC_2     ,     KC_3      ,    _______    ,    _______    ,\
       _______   ,     _______   ,     _______   ,     _______   ,    _______    ,                                                                                                                                                     DECIMAL   ,     _______   ,     _______   ,    NOTHING    ,    BROKEN     ,\
